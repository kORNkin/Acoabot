...
BluetoothSerial SerialBT;                               // Tiny GPS Plus Library - Download from http://arduiniana.org/libraries/tinygpsplus/
...
// int motor_l_2 = 26;
// int pwmr = 27;    
// int pwml = 14;                      // create motor #4, 64KHz pwm-++++++++++++
...
FaBo9Axis compass;                                                  // HMC5883L compass(HMC5883L)
...
{  
  ...
  SerialBT.begin("agribot");                                           // Serial 1 is for Bluetooth communication - DO NOT MODIFY - JY-MCU HC-06 v1.40
